                ...
                <div class="col-md-3 header">
                    ...
                    <div class="addresses">
                      ...
                      <div class="address-1 my-3">
                          <h4 class="text-grey">BORNO: &nbsp;
                              <span>NO. 13 Old GRA, by Nursing Home Maiduguri, Borno State</span>
                          </h4>
                        </div>
                       <div class="address-1 my-3">
                          <h4 class="text-grey">Kogi: &nbsp;
                              <span>Adun Estate behind CBN, off Stadium road, Lokoja, Kogi state </span>
                          </h4>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3 header">
                      <h4>NEWSLETTTER SIGN-UP</h4>
                      <hr />
                      <div class="form-group">
                        <label class="form-label">Email Address</label> 
                        <input type="email" name="email"  class="form-control"/>
                      </div>
                      <button class="btn btn-md btn-success">Subscribe</button>
                  </div>
          </div>
        </div>
      </section>
      <section id="copyright">
        <div class="text-center text-primary h-100 d-flex justify-content-center align-items-center" >
            COPYRIGHT © 2019 Global Relief Initiative 
        </div>
      </section>
    </div>
</template>
